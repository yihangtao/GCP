...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d",
        "--data",
        default="/data2/user2/yihang/GUEST/dataset/V2X-Sim/test",
        type=str,
    ...
    parser.add_argument("--logpath", default="/data2/user2/yihang/GUEST/coperception/logs", help="The path to the output log file")
    parser.add_argument(
        "--resume",
        default="/data2/user2/yihang/GUEST/coperception/ckpt/det/meanfusion/epoch_49.pth",
        type=str,
