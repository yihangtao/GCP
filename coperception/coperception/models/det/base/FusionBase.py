...
class FusionBase(IntermediateModelBase):
    ...
    def forward(self, bevs, trans_matrices, num_agent_tensor, batch_size=1, pert=None, eps=None, attacker_list=None, ego_agent=None, unadv_pert=None, kick=False, no_fuse=False, collab_agent_list=None, trial_agent_id=None, ego_only_neighbors=False):
        ...
        if not no_fuse:
            ...
            for b in range(batch_size):
                ...
                for i in range(self.num_agent):
                    ...
                    if ego_only_neighbors and ego_agent is not None and i == ego_agent:
                        pass
                    else:
